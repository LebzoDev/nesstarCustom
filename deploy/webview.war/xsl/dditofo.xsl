...
<xsl:stylesheet version="1.0" xmlns:date="http://exslt.org/dates-and-times"
	xmlns:ddi="http://www.icpsr.umich.edu/DDI" xmlns:dc="http://purl.org/dc/elements/1.1/"
   ...
   <xsl:param name="allowHTML" select="0"/>
	...
	<xsl:include href="xsl/ddi-pdf/i18n.inc.xslt"/>
   ...
   <xsl:variable name="showVariableGroups">
	...
	<xsl:variable name="time">
		<xsl:if test="$yearFrom">
			...
			<xsl:if test="compare($yearTo, $yearFrom) &gt; 0">
				<xsl:text>-</xsl:text>
					...
					<fo:bookmark internal-destination="variables-description">
						...
						<xsl:for-each select="/ddi:codeBook/ddi:fileDscr">
							<fo:bookmark internal-destination="vardesc-{ddi:fileTxt/ddi:fileName/@ID}">
								...
								<xsl:variable name="fileId" select="ddi:fileTxt/ddi:fileName/@ID"/>
									...
									<xsl:for-each select="/ddi:codeBook/ddi:fileDscr">
										<fo:block margin-left="0.7in" font-size="10pt"
											...
											<fo:basic-link internal-destination="file-{ddi:fileTxt/ddi:fileName/@ID}"
												...
												<fo:leader leader-pattern="dots"/>
												<fo:page-number-citation
													ref-id="file-{ddi:fileTxt/ddi:fileName/@ID}"/>
											</fo:basic-link>
										</fo:block>
									</xsl:for-each>
								</fo:block>
									...
									<xsl:for-each select="/ddi:codeBook/ddi:fileDscr">
										<fo:block margin-left="0.7in" font-size="10pt"
											...
											<fo:basic-link internal-destination="varlist-{ddi:fileTxt/ddi:fileName/@ID}"
												...
												<fo:leader leader-pattern="dots"/>
												<fo:page-number-citation
													ref-id="varlist-{ddi:fileTxt/ddi:fileName/@ID}"/>
											</fo:basic-link>
										</fo:block>
									</xsl:for-each>
								</fo:block>
									...
									<xsl:for-each select="/ddi:codeBook/ddi:fileDscr">
										<fo:block margin-left="0.7in" font-size="10pt"
											...
											<fo:basic-link internal-destination="vardesc-{ddi:fileTxt/ddi:fileName/@ID}"
												...
												<fo:leader leader-pattern="dots"/>
												<fo:page-number-citation
													ref-id="vardesc-{ddi:fileTxt/ddi:fileName/@ID}"/>
											</fo:basic-link>
										</fo:block>
									</xsl:for-each>
								</fo:block>
	...
	<xsl:template match="ddi:contact">
		<fo:block>
			...
			<xsl:if test="@email"> , <fo:basic-link external-destination="url('mailto:{@URI}')"
				text-decoration="underline" color="blue">
	...
	<xsl:template match="ddi:fileDscr">
		...
		<fo:table id="file-{ddi:fileTxt/ddi:fileName/@ID}" table-layout="fixed" width="100%"
